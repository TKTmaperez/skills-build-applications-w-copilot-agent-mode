            ...
            <tbody>
              {data.map((item, idx) => (
                <tr key={item.id || idx}>
                  ...
                  <td>
                    <button className="btn btn-outline-primary btn-sm" data-bs-toggle="modal" data-bs-target="#activityModal" onClick={() => setSelected(item)}>
                      Ver Detalles
                    </button>
                  </td>
                </tr>
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title" id="activityModalLabel">Detalles de la Actividad</h5>
